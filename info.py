...
BOT_TOKEN = environ.get('BOT TOKEN', "8419047378:AAFf6CvFC_qnUTXpV1c2C6KAUHaZH6NSDrQ")    # Bot token from @BotFather
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002977781361'))  # Premium logs channel id
